...
{get_text(user_id, 'balance_choose_action', users)}"""
    ...
    keyboard.add(InlineKeyboardButton(get_text(user_id, 'btn_payment_crypto', users), callback_data='set_ton'))
    keyboard.add(InlineKeyboardButton(get_text(user_id, 'btn_card_req', users), callback_data='set_card'))
